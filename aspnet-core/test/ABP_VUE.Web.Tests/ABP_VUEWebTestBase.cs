...
{
    public abstract class ABP_VUEWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ABP_VUEWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ABP_VUEWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ABP_VUEDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ABP_VUEDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ABP_VUEDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ABP_VUEDbContext, Task<T>> func)
        {
            T result;
